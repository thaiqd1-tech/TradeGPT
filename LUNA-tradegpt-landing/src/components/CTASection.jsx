...
{/* Main Headline */}
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
            Ready to Start Your
            <span className="block text-yellow-400">Free Trial Today?</span>
          </h2>

          {/* Subheadline */}
          <p className="text-xl sm:text-2xl text-gray-200 mb-12 max-w-3xl mx-auto leading-relaxed">
            Choose your perfect plan and start transforming your investment strategy with AI-powered insights in minutes.
          </p>
