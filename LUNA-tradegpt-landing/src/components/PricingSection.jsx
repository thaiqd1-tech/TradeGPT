...
const handlePlanSelect = (planId) => {
  ...
  return (
    <section id="pricing" className="py-24 bg-gradient-to-b from-dark-800 to-dark-900 relative overflow-hidden">
      {/* Background Elements */}
          ...
          {pricingPlans.map((plan, index) => {
            ...
            return (
              ...
              >
                ...
                <div className={`relative h-full bg-gradient-to-br ${plan.bgGradient} backdrop-blur-sm border ${plan.borderColor} rounded-3xl p-8 transition-all duration-500 hover:border-opacity-40 hover:scale-105 hover:shadow-2xl ${
                  plan.isPopular ? 'border-primary-500/30 shadow-xl' : ''
                } ${isHovered ? 'transform scale-105' : ''}`}>
                  
                  {/* Plan Header */}
                  <div className="text-center mb-8">
                    <div className={`inline-flex p-4 rounded-2xl bg-gradient-to-r from-dark-800 to-dark-700 mb-6 group-hover:scale-110 transition-transform duration-300`}>
                      <IconComponent className={`h-8 w-8 ${plan.iconColor}`} />
                    </div>
                    
                    <h3 className="text-2xl font-bold text-white mb-2">{plan.name}</h3>
                    <p className="text-gray-400 text-lg mb-6">{plan.subtitle}</p>
                    ...
                    <div className="flex items-center justify-center gap-4 mb-8">
                      <div className="glass-effect px-4 py-2 rounded-lg">
                        <span className="text-white font-semibold">{plan.assets}</span>
                      </div>
                      <div className="glass-effect px-4 py-2 rounded-lg">
                        <span className="text-white font-semibold">{plan.tokens}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className={`w-full ${plan.buttonStyle} text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center group`}
                  >
                    Get Started
        ...
        <div className="mt-16 text-center">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-center space-x-3">
              ...
              <span className="text-gray-300">99.95% Uptime SLA</span>
            </div>
            <div className="flex items-center justify-center space-x-3">
